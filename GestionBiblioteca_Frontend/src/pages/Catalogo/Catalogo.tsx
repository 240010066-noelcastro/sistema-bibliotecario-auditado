...
const Catalogo: React.FC = () => {
  ...
  // ==========================================
  // LA MAGIA DE GOOGLE BOOKS API (PROXY SEGURO POR BACKEND)
  // ==========================================
  const searchGoogleBooks = async () => {
    ...
    try {
      ...
      // Petición al backend seguro (la API Key nunca se expone en el cliente)
      const res = await api.get('/libros/buscar-google', {
        params: { isbn: cleanCode }
      });
      const data = res.data;
